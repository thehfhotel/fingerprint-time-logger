...
class ConfigManager {
    ...
    getDefaultConfig() {
        return {
            ...
            ui: {
                ...
                healthCheckInterval: 600000, // Changed from 5 minutes to 10 minutes to reduce device connections
                dateFormat: "en-US",
                timeFormat: {
                    hour12: false
                }
    ...
    getApiUrl(endpoint = '') {
        ...
        const noSlashEndpoints = ['devices/time', 'devices/health', 'auto-import/status', 'devices/sync-time', 'refresh', 'attendance/summary', 'admin/line-codes/verify-passcode', 'admin/line-codes/generate', 'admin/line-codes/regenerate', 'admin/line-codes/unlink', 'admin/auth/login', 'admin/auth/validate', 'admin/auth/logout'];
