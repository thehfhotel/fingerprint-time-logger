...
class TestAttendanceEndpoints:
    ...
    def test_get_attendance_list(self, test_client, test_company_setup):
        """Test GET /api/private/attendance/ - Get attendance records"""
    ...
    def test_get_attendance_summary(self, test_client, test_company_setup):
        """Test GET /api/private/attendance/summary - Get attendance summary"""
    ...
    def test_get_attendance_today(self, test_client, test_company_setup):
        """Test GET /api/private/attendance/today - Get today's attendance"""
    ...
    def test_get_employee_attendance(self, test_client, test_company_setup):
        """Test GET /api/private/attendance/employee/{badge} - Get employee attendance"""
        employees = test_company_setup["employees"]
        if employees:
            badge = employees[0].badge_number
            response = test_client.get(f"/api/private/attendance/employee/{badge}")
    ...
    def test_get_employee_attendance_not_found(self, test_client):
        ...
        response = test_client.get("/api/private/attendance/employee/99999")
        assert response.status_code == 404

    def test_attendance_health_check(self, test_client):
        """Test GET /api/private/attendance/health - Health check endpoint"""
    ...
    def test_get_calendar_data(self, test_client, test_company_setup):
        ...
        now = datetime.now()
        response = test_client.get(f"/api/private/attendance/calendar/{now.year}/{now.month}")
        assert response.status_code == 200
        data = response.json()
        assert isinstance(data, dict)

    def test_get_sync_status(self, test_client):
        """Test GET /api/private/attendance/sync/status - Sync status"""
...
class TestAttendanceEndpointsEdgeCases:
    ...
    def test_csv_export_with_invalid_dates(self, test_client):
        ...
        response = test_client.get("/api/private/attendance/export/csv?start_date=invalid&end_date=2024-12-31")
    ...
    def test_employee_attendance_invalid_badge(self, test_client):
        ...
        response = test_client.get("/api/private/attendance/employee/")
...
class TestAttendanceRecordAdjustments:
    ...
    def test_get_record_adjustments_invalid_id(self, test_client):
        ...
        response = test_client.get("/api/private/attendance/records/99999/adjustments")
        assert response.status_code == 404
    ...
    def test_mark_attendance_late_invalid_id(self, test_client):
        ...
        response = test_client.post("/api/private/attendance/records/99999/mark-late", json=adjustment_data)
        assert response.status_code == 404

    def test_delete_adjustment_invalid_ids(self, test_client):
        """Test deleting non-existent adjustment"""
        response = test_client.delete("/api/private/attendance/records/99999/adjustments/99999")
        assert response.status_code == 404
